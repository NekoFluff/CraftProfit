...
if __name__ == "__main__":
  ...
  URLS = [
    "https://www.invenglobal.com/blackdesertonline/recipe/cooking",
    "https://www.invenglobal.com/blackdesertonline/recipe/alchemy"
  ]
  ...
  for URL in URLS:
    ...
    for r in rows: 
      ...
      # Parse Image
      image_src = recipe.find("img").attrs.get('data-src')
